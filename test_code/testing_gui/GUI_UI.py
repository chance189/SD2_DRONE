...
"}")
        ...
        self.dist_value = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.dist_value.setMaximumSize(QtCore.QSize(200, 50))
        self.dist_value.setObjectName("dist_value")
        self.gridLayout_2.addWidget(self.dist_value, 1, 1, 1, 1)
        self.vel_value = QtWidgets.QDoubleSpinBox(self.centralwidget)
        ...
        self.vel_value.setPalette(palette)
